...
app.get('/PatRequest',isLoggedIn,function(req,res){
 if(req.user.role==='Patient')
  { var query="select message,date,Status from message inner join patient_1 on message.pat_id=patient_1.pat_id where patient_1.pat_id=?";
  //  console.log(req.user.login_id);
  ...
  {var temp=req.user.login_id;
    var upload = multer({
      ...
      fileFilter: function(req, file, callback) {
        ...
        // }
        console.log(file);
        var fileloc = 'public/prescription'+'/'+uuidname+'-'+file.originalname+ext
        ...
        console.log(fileloc);
        callback(null, true)
        var query="select pat_id from patient_1 where patient_1.pat_id = ?";
        connection.query(query,[temp],function(err,rows){
          // console.log(req);
          // console.log(req.body);
