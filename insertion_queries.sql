...
INSERT INTO `sample`.`doctor_1`(`doc_name`,`contact`,`specialization`)
...
-- drug manufacturer
INSERT INTO `sample`.`drug_manufacturer`(`name`,`contact`)
...
INSERT INTO `sample`.`patient_1`(`pat_name`,`contact`,`gender`,`insurance_id`,`age`,`address`)
...
INSERT INTO `sample`.`login`(`username`,`password`,`role`)
...
INSERT INTO `sample`.`employee`(`emp_name`,`contact`,`address`,`dob`,`username`)
...
INSERT INTO `sample`.`medicine`(`med_name`,`mrp`,`primary_drug`,`dosage`,`company_id`)
...
INSERT INTO `sample`.`inventory`(`med_id`,`expiry_date`,`total_number`,`emp_id`)
...
INSERT INTO `sample`.`bill_1`(`payment_mode`,`discount`,`pat_id`,`total_cost`)
...
INSERT INTO `sample`.`bill_2`(`bill_no`,`quantity`,`med_id`)
VALUES(1,3,1);
INSERT INTO `sample`.`bill_2`(`bill_no`,`quantity`,`med_id`)
VALUES(2,2,2);
INSERT INTO `sample`.`bill_2`(`bill_no`,`quantity`,`med_id`)
...
INSERT INTO `sample`.`doctor_2`(`doc_id`,`med_id`)
VALUES(1,2);
INSERT INTO `sample`.`doctor_2`(`doc_id`,`med_id`)
VALUES(1,3);
INSERT INTO `sample`.`doctor_2`(`doc_id`,`med_id`)
...
INSERT INTO `sample`.`patient_2`(`pat_id`,`doc_id`)
VALUES(1,2);
INSERT INTO `sample`.`patient_2`(`pat_id`,`doc_id`)
VALUES(2,3);
INSERT INTO `sample`.`patient_2`(`pat_id`,`doc_id`)
